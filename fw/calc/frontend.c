...
// TODO: determine the memory map address for PS/2 peripheral
int *PS2_KEY_AWAIT = 0xFFFF0000;
int *PS2_KEY = 0xFFFF0000;
...
// commented because not updated like vga_print_plain
