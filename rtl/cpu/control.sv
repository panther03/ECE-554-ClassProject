...
always_comb begin
    case (op_word) inside
        ...
        8'b110001_?? : begin RegWrite = 1; MemWrite = 0; MemRead = 1; InstFmt = 2'b01; MemToReg = 1; AluSrc = 1; AluOp = 4'b0000; CondOp = 2'b00; JType = 2'b00; XtendSel = 0; Exc = 0; Rtn = 0; Halt = 0; FPInst = 1; FPIntCvtReg = 2'b00; ctrl_err = 0; ID_EX_Op_in = FLD; end // FLD
        8'b100100_?? : begin RegWrite = 1; MemWrite = 0; MemRead = 0; InstFmt = 2'b10; MemToReg = 0; AluSrc = 1; AluOp = 4'b1000; CondOp = 2'b00; JType = 2'b00; XtendSel = 0; Exc = 0; Rtn = 0; Halt = 0; FPInst = 1; FPIntCvtReg = 2'b10; ctrl_err = 0; ID_EX_Op_in = FCLASS; end // FCLASS
